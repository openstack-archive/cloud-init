...
class OpenStackSource(baseopenstack.BaseOpenStackSource):
    ...
    def load(self):
        ...
        network.set_metadata_ip_route(settings.OPENSTACK_METADATA_URL)
        ...
        try:
            ...
            LOG.warning('Metadata not found at URL %r',
                        settings.OPENSTACK_METADATA_URL)
            return False
    ...
    def _get_data(self, path):
        norm_path = posixpath.join(settings.OPENSTACK_METADATA_URL, path)
